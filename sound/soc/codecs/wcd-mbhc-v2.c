...
/*OPPO 2015-06-24 hanqing.wang Add for reason OPPO_15011 = OPPO_15018, 15062 OPPO_MSM_15062 */
/*OPPO 2015-06-24 hanqing.wang Add for add OPPO_15085 = OPPO_15018, 15085 OPPO_MSM_15085 */
			if ((hph_count == 6) && ((is_project(OPPO_15011)) || (is_project(OPPO_15085)) || (is_project(OPPO_15018)) || (is_project(OPPO_15022))))
			{
		...
		else
		{
					...
					!mbhc->btn_press_intr)
			{
				...
				/*OPPO 2015-06-24 hanqing.wang Add for reason OPPO_15011 = OPPO_15018, 15062 OPPO_MSM_15062 */
	/*OPPO 2015-06-24 hanqing.wang Add for add OPPO_15085 = OPPO_15018, 15085 OPPO_MSM_15085 */
                if (is_project(OPPO_15085) || is_project(OPPO_15011) || is_project(OPPO_15018)) {
                    if(++headset_count == 2) {
                         goto report;
                    } else {
                        continue;
