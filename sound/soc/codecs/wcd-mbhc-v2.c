...
static void wcd_mbhc_set_and_turnoff_hph_padac(struct wcd_mbhc *mbhc)
{
	...
	* removal event to sync-up PA's state */
	...
	snd_soc_update_bits(codec, MSM8X16_WCD_A_ANALOG_RX_HPH_CNP_EN,
		    0x30, 0x00);
	#else
	if(is_project(OPPO_14051) || is_project(OPPO_15005) || is_project(OPPO_15057) || is_project(OPPO_15009)||is_project(OPPO_15037))
	{
...
static void wcd_correct_swch_plug(struct work_struct *work)
{
	...
	/*OPPO 2015-06-24 hanqing.wang Add for add OPPO_15085 = OPPO_15018, 15085 OPPO_MSM_15085 */	
    if (is_project(OPPO_15009) || is_project(OPPO_15037) || is_project(OPPO_15011) || is_project(OPPO_15085) || is_project(OPPO_15018)) {
        #ifdef VENDOR_EDIT
        //John.Xu@PhoneSw.AudioDriver, 2015/06/11, Add for Qcom patch for slow insert headset
            if (mbhc->btn_press_intr) {
                wcd_cancel_btn_work(mbhc);
...
/*OPPO 2015-06-24 hanqing.wang Add for reason OPPO_15011 = OPPO_15018, 15062 OPPO_MSM_15062 */
/*OPPO 2015-06-24 hanqing.wang Add for add OPPO_15085 = OPPO_15018, 15085 OPPO_MSM_15085 */			
			if ((hph_count == 6) && ((is_project(OPPO_15011)) || (is_project(OPPO_15085))|| (is_project(OPPO_15009)) || (is_project(OPPO_15018)) || (is_project(OPPO_15037)) || (is_project(OPPO_15022))))
			{
		...
		else 
		{
					...
					!mbhc->btn_press_intr)
			{
				...
				/*OPPO 2015-06-24 hanqing.wang Add for reason OPPO_15011 = OPPO_15018, 15062 OPPO_MSM_15062 */
	/*OPPO 2015-06-24 hanqing.wang Add for add OPPO_15085 = OPPO_15018, 15085 OPPO_MSM_15085 */					
                if (is_project(OPPO_15009) || is_project(OPPO_15037) || is_project(OPPO_15085) || is_project(OPPO_15011) || is_project(OPPO_15018)) {
                    if(++headset_count == 2) {
                         goto report;
                    } else {
                        continue;
