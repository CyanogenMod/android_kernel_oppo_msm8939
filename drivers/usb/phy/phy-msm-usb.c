...
/*chaoying.chen@EXP.BaseDrv.OTG,2016/02/19 disable otg switch*/
	//if (is_project(OPPO_15009) || is_project(OPPO_15037) || is_project(OPPO_15018)|| is_project(OPPO_15011) || is_project(OPPO_15085))
	//	return 1;
	//else
		return 0;
}
