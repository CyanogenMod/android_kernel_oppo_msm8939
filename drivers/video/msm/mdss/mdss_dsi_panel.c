...
/* YongPeng.Yi@SWDP.MultiMedia, 2015/05/29  Add for 15009 cabc START */
		if((is_project(OPPO_15009)||is_project(OPPO_15037)||is_project(OPPO_15035)||is_project(OPPO_15029)||is_project(OPPO_15109)) && ctrl->ndx==0){
			set_backlight_pwm(1);
...
/* wuyu@EXP.BaseDrv.LCM, 2015-05-18, add micro OPPO_15011, (OPPO15011=OPPO_15018) */
/*huqiao@EXP.BasicDrv.Basic add for clone 15085*/
	if(MSM_BOOT_MODE__NORMAL!=get_boot_mode() && (is_project(OPPO_15011) || is_project(OPPO_15018) || is_project(OPPO_15022) || is_project(OPPO_15085) || is_project(OPPO_15035) || is_project(OPPO_15009) || is_project(OPPO_15029) || is_project(OPPO_15109))){
		pinfo->esd_check_enabled = false;
	}
#endif /*VENDOR_EDIT*/
...
/* YongPeng.Yi@SWDP.MultiMedia, 2015/06/11  Add for lcd type START */
    if(!strcmp(panel_name,"oppo15009jdi nt35592 720p video mode dsi panel")){
...
/*lile@EXP.BasicDrv.LCD, 2015-04-17 add for 15069 ESD screen off automatically */
		...
		if((MSM_BOOT_MODE__FACTORY == get_boot_mode())&&(is_project(OPPO_15009)||is_project(OPPO_15037)||is_project(OPPO_15035)||is_project(OPPO_15029)||is_project(OPPO_15109))){
			ESD_TE_TEST = 0;
		}
