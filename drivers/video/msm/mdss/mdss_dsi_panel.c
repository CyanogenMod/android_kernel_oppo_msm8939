...
/* Xiaori.Yuan@Mobile Phone Software Dept.Driver, 2015/04/10  Add for esd check */
	if(MSM_BOOT_MODE__NORMAL!=get_boot_mode() && (is_project(OPPO_15011) || is_project(OPPO_15018) || is_project(OPPO_15022) || is_project(OPPO_15109))){
		pinfo->esd_check_enabled = false;
	}
#endif /*CONFIG_MACH_OPPO*/
...
/* <- YongPeng.Yi@SWDP.MultiMedia, 2015/06/11  Add for 15037 read reg START */
			if((lcd_dev == LCD_15037_TRULY_HX8389C)||(lcd_dev == LCD_15035_TM_OTM9605)||(lcd_dev == LCD_15069_TM_OTM9605A)||(lcd_dev == LCD_15035_TRULY_HX8389C) || is_project(OPPO_15109)){
